...
const renderGame = (game: GameConfig, index: number) => {
  ...
  const rulebookLink = game.slug === "investigation-delve" ? `<a class="text-link project-cta project-rules-link" href="/investigation-delve-boardgame/rules"><span data-game-i18n="${rulebookKey}"></span><span aria-hidden="true">↗</span></a>` : "";
