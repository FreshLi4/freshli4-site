...
const knownGames: GameConfig[] = [
  {
    ...
    description: copy("一款支持 2–6 人游玩的黑暗调查策略卡牌游戏。你将扮演“指挥者”，操控调查员接近禁忌真相，利用策略牌、角色技能与行动顺位保护己方，并诱导对手比你更早陷入疯狂。", "A dark investigative strategy card game for 2–6 players. Command your investigator toward forbidden truths, use cards, abilities, and turn order to protect your side, and push your rivals into madness first.", "2〜6人向けのダーク調査ストラテジーカードゲーム。指揮官として調査員を禁忌の真実へ導き、相手を先に狂気へ追い込みます。"),
    tags: [copy("桌游", "TABLETOP", "ボードゲーム"), copy("策略卡牌", "STRATEGY CARD GAME", "戦略カード"), copy("2–6 人", "2–6 PLAYERS", "2〜6人")], cta: copy("购买", "BUY", "購入"), noteA: "CASE<br />OPEN", noteB: "1998", link: "https://xhslink.com/m/lDaRjSilOC",
  },
  {
  ...
  },
  {
    ...
    description: copy("在 2084 年的 Noctropolis，作为不断复生的 Drifter 潜入城市深处。构建义体、改造武器，在一次次死亡留下的记忆中追踪“永生计划”。", "In Noctropolis, 2084, descend into the city as a repeatedly resurrected Drifter. Rebuild cyberware and weapons while following the traces of an immortality project left across memories of death.", "2084年のNoctropolis。何度も蘇るDrifterとして都市の深部へ潜入し、「不死計画」を追います。"),
    tags: [copy("Steam", "STEAM"), copy("Roguelike ARPG", "ROGUELIKE ARPG"), copy("赛博朋克", "CYBERPUNK")], cta: copy("敬请期待", "COMING SOON", "続報をお待ちください"), noteA: "MEMORY<br />STACK", noteB: "2084",
  },
];
